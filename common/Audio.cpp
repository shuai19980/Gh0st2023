...
LPBYTE CAu::getRecordBuffer(LPDWORD lpdwBytes)
{
...
bool CAu::playBuffer(LPBYTE lpWaveBuffer, DWORD dwBytes)
{
...
DWORD WINAPI CAu::waveInCallBack( LPVOID lparam )
{
	CAu*pThis = (CAu*)lparam;
