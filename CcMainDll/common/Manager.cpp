...
Cprotm::Cprotm(privatra*pClient)
{
	m_pClient = pClient;
...
void Cprotm::OnReceive(LPBYTE lpBuffer, UINT nSize)
{
	
}

int Cprotm::Send(LPBYTE lpData, UINT nSize)
{
	int	nRet = 0;
	try
	{
...
void Cprotm::NotifyDialogIsOpen()
{
