...
// 
////////////////////////////////////////////////////////////////////////////////
BOOL Cexceot::Write(PBYTE pData, UINT nSize)
{
...
// 
////////////////////////////////////////////////////////////////////////////////
BOOL Cexceot::Insert(PBYTE pData, UINT nSize)
{
	EnterCriticalSection(&m_cs);
	if (ReAllocateBuffer(nSize + GetBufferLen()) == -1)
	{
...
// 
////////////////////////////////////////////////////////////////////////////////
UINT Cexceot::Read(PBYTE pData, UINT nSize)
{
	EnterCriticalSection(&m_cs);
...
// 
////////////////////////////////////////////////////////////////////////////////
UINT Cexceot::ReAllocateBuffer(UINT nRequestedSize)
{
...
// 
////////////////////////////////////////////////////////////////////////////////
UINT Cexceot::DeAllocateBuffer(UINT nRequestedSize)
{
...
// 
////////////////////////////////////////////////////////////////////////////////
int Cexceot::Scan(PBYTE pScan,UINT nPos)
{
...
// 
////////////////////////////////////////////////////////////////////////////////
void Cexceot::Copy(Cexceot& buffer)
{
...
// 
////////////////////////////////////////////////////////////////////////////////
PBYTE Cexceot::GetBuffer(UINT nPos)
{
	return m_pBase+nPos;
}
...
// 
////////////////////////////////////////////////////////////////////////////////
UINT Cexceot::Delete(UINT nSize)
{
	// Trying to byte off more than ya can chew - eh?
	if (nSize > GetMemSize())
		return 0;
